...
export function updateSubCourse(id, data) {
    console.log('🚀 ~ file: service.js:147 ~ updateSubCourse ~ data:', data);
    return axiosClient
...
export function deleteChapter(id, data) {
    console.log('🚀 ~ file: service.js:161 ~ deleteChapter ~ data:', data);
    return axiosClient
        .delete(`/api/admin/courses/${id}/chapter`, { ...data })
        .then((response) => {
            return response;
        });
}
...
export function updateChapter(id, data) {
    return axiosClient
        .put(`/api/admin/courses/${id}/chapter`, { ...data })
        .then((response) => {
            return response;
        });
}
...
export function deleteSubCourse(id) {
    return axiosClient
        .delete(`/api/admin/subCourses/${id}`)
        .then((response) => {
            return response;
        });
}
